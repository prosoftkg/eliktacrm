...
class MyWorker extends Worker
{
     ...
     * Parse command.
     *
     * Inherited by Temir. Original has a bug for yii. $argv indexes have been incremented
     * and -d and -g were changed to d and g.
     *
     * @return void
     */
    protected static function parseCommand()
    {
        ...
        if (!isset($argv[2]) || !in_array($argv[2], $available_commands)) {
            if (isset($argv[2])) {
                static::safeEcho('Unknown command suka: ' . $argv[2] . "\n");
            }
            exit($usage);
        }
        ...
        if ($master_is_alive) {
            ...
            static::log("Workerman[$start_file] is not running");
            exit;
        }
